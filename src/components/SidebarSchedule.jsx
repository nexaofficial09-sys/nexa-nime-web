    ...
    return (
        <div className="flex flex-col gap-4 mt-8">
            ...
            <div className="bg-white border-[2px] border-[#1a202c] rounded-sm px-4 py-2.5 shadow-[3px_3px_0_0_#1a202c]">
                <h3 className="font-sans font-extrabold text-lg text-[#1a202c] tracking-tight uppercase flex items-center justify-between">
                    <span>JADWAL HARI INI</span>
                    <span className="text-[#e50914] text-[12px]">{currentDay}</span>
                </h3>
            </div>

            {/* List */}
            <div className="flex flex-col gap-3">
                {scheduleList.map((anime, index) => (
                    <Link 
                        key={index} 
                        to={`/anime/${anime.id}`}
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="flex flex-col justify-center min-w-0 flex-grow py-0.5">
                                ...
                                <div className="flex justify-between items-center mt-auto">
                                    ...
                                    <span className="text-[9px] font-extrabold bg-[#2ecc71] text-white px-1.5 py-0.5 rounded-[4px] whitespace-nowrap shadow-sm">
                                        ONGOING
                                    </span>
                                </div>
                            </div>
